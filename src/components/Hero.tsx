  ...
  return (
    <section className="relative h-[100svh] flex flex-col items-center justify-center overflow-hidden bg-[#FAF9F6] pt-16">
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-0">
        <img src="https://yashjariwala.github.io/Invite/watercolor_floral.png" alt="Floral Frame" style={{ width: "100%", height: "100%" }} className="object-cover opacity-80 mix-blend-multiply"  />
      </div>
